...
import './events.css';
import { initEventDetails } from '@/lib/pages/events';
    ...
    <>
      ...
      <section className="event-banner" id="event-hero">
        <div className="banner-content container">
          <span className="event-tag" id="event-status-tag">Upcoming Event</span>
          <h1 id="event-title">Loading Event...</h1>
          <p className="event-short-desc" id="event-short-desc">Please wait while we fetch the event details.</p>
          ...
          <button className="btn-primary" id="open-register-btn">Register Now</button>
        </div>
      ...
      <div className="modal-overlay" id="registration-modal">
        <div className="modal-container">
          <button className="close-modal-btn" id="close-modal-btn">&times;</button>
          
          <div className="modal-header">
            <h2>Event Registration</h2>
            <p>Secure your spot for <span id="modal-event-name">this event</span></p>
          </div>
          ...
          <form id="registration-form">
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="text" id="organization" name="organization" required placeholder="University Name" />
              </div>
              <div className="form-group">
                <label htmlFor="role">Year / Role</label>
                <input type="text" id="role" name="role" required placeholder="e.g. 3rd Year / Developer" />
              </div>
            </div>

            <div className="form-group">
              <label htmlFor="reason">Why do you want to attend?</label>
              <textarea id="reason" name="reason" rows={3} required placeholder="Briefly explain your interest..."></textarea>
            </div>

            <div className="form-actions">
              <button type="button" className="btn-secondary" id="cancel-btn">Cancel</button>
              <button type="submit" className="btn-primary full-width">Submit Registration</button>
            </div>
          </form>
        </div>
      </div>
