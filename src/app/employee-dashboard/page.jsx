  ...
  return (
    <>
      ...
      <div className="bg-gray-100">
        <div className="dashboard-container">
          ...
          <aside className="sidebar" id="sidebar">
            ...
            <div
              ...
              style={{ textAlign: 'center', marginBottom: '2rem', color: '#a6a6b7' }}
            >
              <div id="sidebar-user-name" style={{ fontWeight: 600, color: 'white' }}>
                Loading...
              </div>
              <div id="sidebar-user-id" style={{ fontSize: '0.8rem' }}>
                ...
              </div>
            </div>
            <nav className="nav-links">
              <button className="active" onClick={() => showSection('dashboard')}>
                Dashboard
              </button>
              <button onClick={() => showSection('tasks')}>My Tasks</button>
              <button onClick={() => showSection('leaves')}>Apply Leave</button>
              <button
                onClick={() => logoutUser()}
          ...
          <main className="main-content">
            {/* SECTION: DASHBOARD (Attendance & Stats) */}
            <section id="dashboard-section">
              ...
              <div className="card-grid">
                ...
                <div className="card">
                  ...
                  <div className="stat-value" id="stat-attendance">
                    0%
                  </div>
                </div>
                <div className="card">
                  <h3>Leaves Taken</h3>
                  <div className="stat-value" id="stat-leaves">
                    0
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div className="flex" style={{ gap: '1rem' }}>
                ...
                <button
                  ...
                  onClick={() => closeModal('submit-task-modal')}
                >
                  Cancel
                </button>
              </div>
        ...
        {/* Face Verification Modal (Re-used for attendance) */}
        <div id="camera-modal" className="modal hidden">
          <div className="modal-content">
            ...
            <button
              id="close-modal"
              className="btn-text"
              onClick={() => closeModal('camera-modal')}
            >
              Cancel
            </button>
          </div>
